...
EChartCallout::EChartCallout(QChart *chart):QGraphicsItem(chart),m_chart(chart)
{

}

QRectF EChartCallout::boundingRect() const
{
...
void EChartCallout::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    QPainterPath path;
...
void EChartCallout::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    event->setAccepted(true);
}

void EChartCallout::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void EChartCallout::setText(const QString &text)
{
    m_text = text;
...
void EChartCallout::setAnchor(QPointF point)
{
    m_anchor = point;
}

void EChartCallout::updateGeometry()
{
    prepareGeometryChange();
